...
mat4 Object::Render(){
	...
	mat4 modelMatrix = rotationMatrix * translateMatrix * scaleMatrix * identityMatrix;	//Model in world space
	//glm::scale(translateMatrix, scale);			(^Not Necessary in the code.)


	//(model in world space) =translateMatrix * scale * (starting model coordinates) [This is what is happening above]
